#!/usr/bin/env python3
import argparse
from Gui.MainWindow_headless import MainWindow_headless
from Service.CarlaProcessor_headless import CarlaProcessorService_headless
...
def main():
    ...
    print("==========================================")
    print("     CARLA Headless Client Launcher")
    print("==========================================")
    ...
    # ========== CARLA Connector ==========
    carlaConnector = CarlaProcessorService_headless()
    ...
    # ========== Start GUI ==========
    print("Starting headless main window...")
    MainWindow_headless("CARLA client 0.10",
               carlaConnector,
               usedVehicles,
               settings)
